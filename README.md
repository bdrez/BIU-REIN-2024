...
*NOTE: this README assumes prior familiarity with RE:IN. For an explanation of the technical background (both biological and computational), see abstract here
